...
from .. icaros  .selection_functions import eff_of_selection
from .. icaros  .selection_functions import select_var_inrange
from .. icaros  .selection_functions import select_1S1_1S2
...
def test_select_1S1_1S2():
    ...
    assert len(kdst_selected) == 3
    assert kdst_selected.event.to_list() == [3,4,5]
