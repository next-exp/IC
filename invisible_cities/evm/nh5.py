...
class NtupleTable(tb.IsDescription):
    ...
    xavg     = tb.Float64Col(pos=5)
    yavg     = tb.Float64Col(pos=6)
    zavg     = tb.Float64Col(pos=7)
    xmin     = tb.Float64Col(pos=8)
    ymin     = tb.Float64Col(pos=9)
    zmin     = tb.Float64Col(pos=10)
    xmax     = tb.Float64Col(pos=11)
    ymax     = tb.Float64Col(pos=12)
    zmax     = tb.Float64Col(pos=13)
