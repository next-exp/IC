...
class TracksTable(tb.IsDescription):
    ...
    track_len = tb.  Int32Col(pos=3)
    voxel_no  = tb.  Int32Col(pos=4)
    X         = tb.Float64Col(pos=5)
    Y         = tb.Float64Col(pos=6)
    Z         = tb.Float64Col(pos=7)
    E         = tb.Float64Col(pos=8)
    size      = tb.Float64Col(pos=9, shape=3)

class NtupleTable(tb.IsDescription):
    event    = tb.  Int32Col(pos=0)
    time     = tb.Float64Col(pos=1)
    S2e      = tb.Float64Col(pos=2)
    S2ec     = tb.Float64Col(pos=3)
    S2q      = tb.Float64Col(pos=4)
    nvox     = tb.Float64Col(pos=5)
    ntrks    = tb.Float64Col(pos=6)
    lmtrk    = tb.Float64Col(pos=7)
    eblob1   = tb.Float64Col(pos=8)
    eblob2   = tb.Float64Col(pos=9)
    xavg     = tb.Float64Col(pos=10)
    yavg     = tb.Float64Col(pos=11)
    zavg     = tb.Float64Col(pos=12)
    xmin     = tb.Float64Col(pos=13)
    ymin     = tb.Float64Col(pos=14)
    zmin     = tb.Float64Col(pos=15)
    xmax     = tb.Float64Col(pos=16)
    ymax     = tb.Float64Col(pos=17)
    zmax     = tb.Float64Col(pos=18)
    emtrk    = tb.Float64Col(pos=19,shape=10)
    xmtrk    = tb.Float64Col(pos=20,shape=10)
    ymtrk    = tb.Float64Col(pos=21,shape=10)
    zmtrk    = tb.Float64Col(pos=22,shape=10)
