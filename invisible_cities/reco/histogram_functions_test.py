...
from invisible_cities.evm.histos_test import assert_histogram_equality
from invisible_cities.evm.histos_test import histograms_lists
from invisible_cities.evm.histos_test import bins_arrays
...
def test_join_histograms_from_file_and_write(output_tmpdir, histogram_list):
    ...
    file_out1 = os.path.join(output_tmpdir, 'test_save_histogram_manager_1.h5')
    histogram_manager.save_to_file(file_out1)

    file_out = os.path.join(output_tmpdir, 'test_join_histograms.h5')
    _ = histf.join_histograms_from_files([file_out1, file_out1], file_out)
