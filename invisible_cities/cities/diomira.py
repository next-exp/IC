...
class Diomira(City):
    ...
    # TODO different cities have different kinds of output files, so,
    # for the time being they have distinct output file setting
    # functions. See if this can be unified.
    ...
    def run(self, nmax):
        ...
        print("""
                 ...
                 Input Files = {}
                 Output File = {}
                          """.format(nmax, self.input_files, self.h5out))
        ...
        for ffile in self.input_files:
            ...
            with tb.open_file(filename, "r") as h5in:
                ...
                if first == False:
                    ...
                    self.fee_table = self.h5out.create_table(MC, "FEE", FEE,
                                      "EP-FEE parameters",
                                      tbl.filters("NOCOMPR"))
                    # create vectors
