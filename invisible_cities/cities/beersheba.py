...
def deconvolve_signal(det_db          : pd.DataFrame,
                      ...
                      bin_size        : List[float],
                      satellite_iter  : int = 9999,
                      satellite_dist  : int = 2,
                      satellite_size  : int = 15,
    ...
    def deconvolve_hits(df, z):
        ...
        if   deconv_mode is DeconvolutionMode.joint:
            ...
            deconv_image = nan_to_num(richardson_lucy(deconv_image, psf, satellite_iter, satellite_dist, satellite_size, e_cut, cut_type, n_iterations_g, iteration_tol))
