...
def test_cities_carry_on_configuration_from_previous_ones(ICDATADIR, config_tmpdir):
    ...
    pmaps_file = os.path.join(config_tmpdir, "test_cities_carry_on_configuration_pmaps.h5")
    kdst_file  = os.path.join(config_tmpdir, "test_cities_carry_on_configuration_kdst.h5")
