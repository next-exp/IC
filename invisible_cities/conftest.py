...
def mc_particle_and_hits_nexus_data(ICDATADIR):
    X     = [ 0.05743197,  0.04000545,  0.08414675,  0.07874712,  0.08354501]
    Y     = [-0.06131169,  -0.0195109, -0.03366733, -0.03738057, -0.03315299]
    Z     = [ 0.01450047,  0.05894583,   0.0464238,  0.02786737,  0.02824999]
    E     = [ 0.00454257,   0.0036288,  0.00809665,  0.00556293,  0.00489734]
    t     = [ 0.00091335,  0.00165484,  0.00226523,  0.00259462,  0.00275008]

    vi    = np.array([        0.,          0.,          0.,          0.])
    vf    = np.array([0.08354501, -0.03315299,  0.02824999,  0.00275008])
