...
class EventMeta(object):
    """Baseclass for accessing geometry information
    
    Core meta information class for 3D geometry description.  Only one inherited class
    for now, but in the future I expect more.
    
    """

    def __init__(self):
        super(EventMeta, self).__init__
        self._x_min        = None
        self._y_min        = None
        self._z_min        = None
        self._x_max        = None
        ...
        self._x_n_pixels   = None
        self._y_n_pixels   = None
        # Use 1 pixel per mm of drift
        self._z_n_pixels   = None
        self._size_voxel_x = None
        self._size_voxel_y = None
        self._size_voxel_z = None
